...
export const costCatalog = [
  ...
  { id: "cc-bur-01", group: "other", driver: "count", label: "непряк труд", defaults: { qty: 1 } },
  { id: "cc-bur-02", group: "other", driver: "count", label: "вътрешен транспорт", defaults: { qty: 1 } },
  { id: "cc-bur-03", group: "other", driver: "percent", label: "режийни и подръжка", defaults: { percent: 0 } },
  { id: "cc-bur-04", group: "other", driver: "percent", label: "административни разходи", defaults: { percent: 0 } },
  { id: "cc-bur-05", group: "other", driver: "percent", label: "маркетинг и реклама", defaults: { percent: 0 } },
  { id: "cc-bur-06", group: "other", driver: "allocation", label: "амортизации", defaults: { fixedTotal: 0, allocationUnits: 1 } },
  { id: "cc-bur-07", group: "other", driver: "percent", label: "финансови", defaults: { percent: 0 } },
  { id: "cc-bur-08", group: "other", driver: "count", label: "разходи за инструменти", defaults: { qty: 1 } },
  { id: "cc-bur-09", group: "other", driver: "count", label: "други", defaults: { qty: 1 } },
